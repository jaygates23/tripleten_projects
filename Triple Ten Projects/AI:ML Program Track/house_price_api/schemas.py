...
class PredictionResponse(BaseModel):
    ...
    predicted_price: float = Field(
        ...,
        description="The predicted house price generated by the model"
    )
    currency: str = Field(
        default="USD",
    ...
    model_version: str = Field(
        ...,
        description="Version of the model used to generate the prediction"
    )
...
class ModelInfoResponse(BaseModel):
    ...
    model_type: str = Field(
        ...,
        description="Type of model used (e.g., Linear Regression, Random Forest)"
    )
    version: str = Field(
        ...,
        description="Current version of the trained model"
    )
    ...
    description: str = Field(
        ...,
        description="High-level description of the model and its purpose"
    )
...
class HealthCheckResponse(BaseModel):
    ...
    status: str = Field(
        ...,
        description='Health status of the service ("healthy" or "unhealthy")'
    )
    model_loaded: bool = Field(
        ...,
        description="Indicates whether the model is successfully loaded"
    )
    message: str = Field(
        ...,
        description="Additional information about the service health"
    )